package com.github.coutinhonobre.mlkittranslate.main
...
import com.github.coutinhonobre.mlkittranslate.main.MainFragment.Companion.DESIRED_HEIGHT_CROP_PERCENT
import com.github.coutinhonobre.mlkittranslate.main.MainFragment.Companion.DESIRED_WIDTH_CROP_PERCENT
import com.github.coutinhonobre.mlkittranslate.util.Language
import com.github.coutinhonobre.mlkittranslate.util.ResultOrError
import com.github.coutinhonobre.mlkittranslate.util.SmoothedMutableLiveData
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val languageIdentifier = LanguageIdentification.getClient(LanguageIdentificationOptions.zza)
    ...
    val sourceLang: MutableLiveData<Language> = sourceText.switchMap { text ->
        val result = MutableLiveData<Language>()
        languageIdentifier.identifyLanguage(text)
            .addOnSuccessListener { languageCode ->
                if (languageCode != "und") result.value = Language(languageCode)
            }
        result
    } as MutableLiveData<Language>
